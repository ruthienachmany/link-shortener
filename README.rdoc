...
I've used ngrok (https://ngrok.com/) here to create an introspected tunnel to my localhost:3000, which exposes it to you (the user). You can check out your shortened link at ``http://14670d52.ngrok.com/YOUR-SHORTENED-URL-HERE``. You can create your own 
